...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.DMToolbar = QAction("&Data Manag", self)
        self.DMToolbar.setShortcut("Ctrl+Shift+o")
        self.DMToolbar.setStatusTip('Retrieve data from GridEdgeDM')
        self.DMToolbar.triggered.connect(self.resultswind.openWindowDM)
        ...
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.DMToolbar)
        self.toolBar.addSeparator()
    ...
    def preAcqMessage(self, event):
        preAcqMessBox = CustomTitleMessageBox("Check Alignment and Irradiance")
...
####################################################################
class CustomTitleMessageBox(QMessageBox):
    def __init__(self, msg):
        super(CustomTitleMessageBox, self).__init__()
