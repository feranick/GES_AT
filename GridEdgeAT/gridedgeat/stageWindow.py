...
class StageWindow(QMainWindow):
    ...
    def initUI(self, StageWindow):
        ...
        self.upButton.setText("-Y")
        self.upButton.setShortcut("-Y")
        ...
        self.leftButton.setText("+X")
        self.leftButton.setShortcut("+X")
        ...
        self.rightButton.setText("-X")
        self.rightButton.setShortcut("-X")
